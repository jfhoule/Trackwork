The HTML files have been removed and the pages in the `app` directory are now using live data from your Supabase backend. I have also implemented basic functionality for the placeholder pages.
